...
/**
 * @test
 * @build com.anatawa12.fixrtm.nashorn.api.javaaccess.test.SharedObject com.anatawa12.fixrtm.nashorn.api.javaaccess.test.Person com.anatawa12.fixrtm.nashorn.api.javaaccess.test.ObjectAccessTest
 * @run testng/othervm com.anatawa12.fixrtm.nashorn.api.javaaccess.test.ObjectAccessTest
 */
...
public class ObjectAccessTest {
    ...
    public static void setUpClass() throws ScriptException {
        ...
        e.eval("var Person = Packages.com.anatawa12.fixrtm.nashorn.api.javaaccess.test.Person;");
    }
    ...
    public void accessFieldObjectArray() throws ScriptException {
        ...
        e.eval("var t_object_arr = new (Java.type(\"com.anatawa12.fixrtm.nashorn.api.javaaccess.test.Person[]\"))(3);" +
    ...
    public void accessStaticFieldObjectArray() throws ScriptException {
        ...
        e.eval("var ts_object_arr = new (Java.type(\"com.anatawa12.fixrtm.nashorn.api.javaaccess.test.Person[]\"))(3);" +
    ...
    public void accessFinalFieldObjectArray() throws ScriptException {
        ...
        e.eval("var tf_object_arr = new (Java.type(\"com.anatawa12.fixrtm.nashorn.api.javaaccess.test.Person[]\"))(3);" +
    ...
    public void accessStaticFinalFieldObjectArray() throws ScriptException {
        ...
        e.eval("var tsf_object_arr = new (Java.type(\"com.anatawa12.fixrtm.nashorn.api.javaaccess.test.Person[]\"))(3);" +
