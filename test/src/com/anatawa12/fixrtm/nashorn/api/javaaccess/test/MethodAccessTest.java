...
/**
 * @test
 * @build com.anatawa12.fixrtm.nashorn.api.javaaccess.test.SharedObject com.anatawa12.fixrtm.nashorn.api.javaaccess.test.Person com.anatawa12.fixrtm.nashorn.api.javaaccess.test.MethodAccessTest
 * @run testng/othervm com.anatawa12.fixrtm.nashorn.api.javaaccess.test.MethodAccessTest
 */
...
public class MethodAccessTest {
    ...
    public void accessDefaultConstructor() throws ScriptException {
        e.eval("var dc = new Packages.com.anatawa12.fixrtm.nashorn.api.javaaccess.test.Person()");
        assertEquals(new Person(), e.get("dc"));
    }

    @Test
    public void accessCustomConstructor() throws ScriptException {
        e.eval("var cc = new Packages.com.anatawa12.fixrtm.nashorn.api.javaaccess.test.Person(17)");
