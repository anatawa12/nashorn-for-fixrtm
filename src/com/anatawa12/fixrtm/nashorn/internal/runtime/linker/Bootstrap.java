...
public final class Bootstrap {
    ...
    public static final Call BOOTSTRAP = staticCallNoLookup(Bootstrap.class, "bootstrap", SCallSite.class, Lookup.class, String.class, MethodType.class, int.class);

    private static final MethodHandleFunctionality MH = MethodHandleFactory.getFunctionality();

    private static final SMethodHandle VOID_TO_OBJECT = MH.constant(Object.class, ScriptRuntime.UNDEFINED);
     ...
     * @param lookup SMethodHandle lookup. Ignored as Nashorn only uses public lookup.
     ...
     */
    public static SCallSite mathBootstrap(final Lookup lookup, final String name, final MethodType type, final int programPoint) {
        ...
        return new SConstantCallSite(MH.insertArguments(mh, mh.type().parameterCount() - 1, programPoint));
    }
     ...
     */
    public static SMethodHandle createDynamicInvoker(final String opDesc, final Class<?> rtype, final Class<?>... ptypes) {
     ...
     */
    private static SMethodHandle unboxReturnType(final SMethodHandle target, final MethodType newType) {
        ...
        if (TypeUtilities.isWrapperType(oldReturnType)) {
            if (newReturnType.isPrimitive()) {
                ...
                return SMethodHandles.explicitCastArguments(target, targetType.changeReturnType(newReturnType));
            }
        } else if (oldReturnType == void.class && newReturnType == Object.class) {
            return SMethodHandles.filterReturnValue(target, VOID_TO_OBJECT);
        }
        return target;
    }
}
