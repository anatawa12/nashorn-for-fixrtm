...
import static com.anatawa12.fixrtm.nashorn.internal.codegen.ClassEmitter.Flag.PRIVATE;
import static com.anatawa12.fixrtm.nashorn.internal.codegen.ClassEmitter.Flag.STATIC;
...
import static com.anatawa12.fixrtm.nashorn.internal.codegen.CompilerConstants.GET_MAP;
import static com.anatawa12.fixrtm.nashorn.internal.codegen.CompilerConstants.GET_STRING;
import static com.anatawa12.fixrtm.nashorn.internal.codegen.CompilerConstants.QUICK_PREFIX;
import static com.anatawa12.fixrtm.nashorn.internal.codegen.CompilerConstants.REGEX_PREFIX;
import static com.anatawa12.fixrtm.nashorn.internal.codegen.CompilerConstants.SCOPE;
import static com.anatawa12.fixrtm.nashorn.internal.codegen.CompilerConstants.SPLIT_PREFIX;
...
import static com.anatawa12.fixrtm.nashorn.internal.codegen.CompilerConstants.interfaceCallNoLookup;
...
import static com.anatawa12.fixrtm.nashorn.internal.ir.Symbol.HAS_SLOT;
import static com.anatawa12.fixrtm.nashorn.internal.ir.Symbol.IS_INTERNAL;
...
import static com.anatawa12.fixrtm.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_APPLY_TO_CALL;
import static com.anatawa12.fixrtm.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_DECLARE;
import static com.anatawa12.fixrtm.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_FAST_SCOPE;
import static com.anatawa12.fixrtm.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_OPTIMISTIC;
...
import static com.anatawa12.fixrtm.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_SCOPE;
...
import com.anatawa12.fixrtm.nashorn.internal.AssertsEnabled;
import com.anatawa12.fixrtm.nashorn.internal.IntDeque;
import com.anatawa12.fixrtm.nashorn.internal.codegen.ClassEmitter.Flag;
...
import com.anatawa12.fixrtm.nashorn.internal.ir.BaseNode;
...
import com.anatawa12.fixrtm.nashorn.internal.ir.GetSplitState;
...
import com.anatawa12.fixrtm.nashorn.internal.ir.JumpStatement;
import com.anatawa12.fixrtm.nashorn.internal.ir.JumpToInlinedFinally;
import com.anatawa12.fixrtm.nashorn.internal.ir.LabelNode;
import com.anatawa12.fixrtm.nashorn.internal.ir.LexicalContext;
import com.anatawa12.fixrtm.nashorn.internal.ir.LexicalContextNode;
...
import com.anatawa12.fixrtm.nashorn.internal.ir.LiteralNode.PrimitiveLiteralNode;
...
import com.anatawa12.fixrtm.nashorn.internal.ir.ReturnNode;
import com.anatawa12.fixrtm.nashorn.internal.ir.RuntimeNode;
import com.anatawa12.fixrtm.nashorn.internal.ir.RuntimeNode.Request;
import com.anatawa12.fixrtm.nashorn.internal.ir.SetSplitState;
import com.anatawa12.fixrtm.nashorn.internal.ir.SplitReturn;
...
import com.anatawa12.fixrtm.nashorn.internal.ir.visitor.NodeOperatorVisitor;
...
import com.anatawa12.fixrtm.nashorn.internal.runtime.OptimisticReturnFilters;
...
import com.anatawa12.fixrtm.nashorn.internal.runtime.RewriteException;
...
import com.anatawa12.fixrtm.nashorn.internal.runtime.UnwarrantedOptimismException;
...
final class CodeGenerator extends NodeOperatorVisitor<CodeGeneratorLexicalContext> implements Loggable {
    ...
    private MethodEmitter globalAllocateArray(final ArrayType type) {
        ...
        return method.invokestatic(GLOBAL_OBJECT, "allocate", "(" + type.getDescriptor() + ")Lcom/anatawa12/fixrtm/nashorn/internal/objects/NativeArray;");
    }
