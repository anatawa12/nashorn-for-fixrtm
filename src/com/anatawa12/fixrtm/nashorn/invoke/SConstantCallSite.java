...
public class SConstantCallSite extends ConstantCallSite implements SCallSite {
    public final SMethodHandle target;

    public SConstantCallSite(SMethodHandle target) {
