...
public class SMutableCallSite extends MutableCallSite implements SCallSite {
    public SMethodHandle real;

    public SMutableCallSite(MethodType type) {
        this(Utils.makeUninitializedCallSite(type));
    }

    public SMutableCallSite(SMethodHandle target) {
